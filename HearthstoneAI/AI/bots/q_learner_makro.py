...
#     learning_rate = 0.8
#     discount_factor = 0.8
#     states_and_actions_num = 0 + 1 + 150 + 5 + 5 + 5 + 1
...
#         super(Q_learner_makro, self).__init__(name, self.original_deck, hero)
#      
...
#             self.update_neural_network(self.previous_state, self.previous_q_value, state, self.previous_action, self.get_reward())
...
#      
#     def get_reward(self):
#         result = (self.used_mana/self.max_mana)*10
#         result = result + self.previous_opp_hero_hp - self.opponent.hero.health
#         return result
#      
#     def get_state(self):
#         state = []
