...
path_to_replay = "C:\\Users\\Lubko\\OneDrive\\Documents\\matfyz\\bakalarka\\Hearthstone-Deck-Tracker-master\\Hearthstone Deck Tracker\\obj\\Debug\\Replay\\Replays\\"
path_to_text_output = 'C:\\Users\\Lubko\\OneDrive\\Documents\\matfyz\\bakalarka\\Hearthstone-Deck-Tracker-master\\Hearthstone Deck Tracker\\obj\\Debug\\Replay\\Replays\\log.txt'

def play_full_game(json, game, player1, player2):
    global __last_turn__
    global path_to_text_output
    f1 = open(path_to_text_output, 'w')
...
def test_full_game():
    ...
    try:
        ...
        path_to_replay = path_to_replay  + my_datetime.strftime("%d_%B_%Y__%H_%M.hdtreplay")
